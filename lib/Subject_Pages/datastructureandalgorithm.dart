...
class DSA extends StatelessWidget {
  ...
  Widget _buildNotesTab(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        InsideButtons(
          text: 'IMP Question And Answers - 1',
          //fileSize: '11',
        ...
        InsideButtons(
          text: 'IMP Question And Answers - 2',
          //fileSize: '3',
          icon: Icons.arrow_forward,
          onTap: () async {
            //adState.showInterstitialAd(); // Show the interstitial ad
        ...
        InsideButtons(
          text: 'IMP Question And Answers - 3',
          //fileSize: '3',
          icon: Icons.arrow_forward,
          onTap: () async {
            //adState.showInterstitialAd(); // Show the interstitial ad
        ...
        child: Column(
          ...
          children: [
            ...
            InsideButtons(
              ...
              onTap: () {
                openPDF(context,
                    'https://notesioe.com/wp-content/uploads/2023/10/Data-Structure-And-Algorithem.pdf');
              },
            ),
            SizedBox(height: 30),
            Text(
